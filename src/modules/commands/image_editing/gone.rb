module Bot::DiscordCommands
  module ImageEditing
    ...
    command(:gone, type: :'Image Editing') do |event|
      ...
      append_image2 = Magick::Image.from_blob(event.image_source).first.scale(410, 410)
      append_image3 = Magick::Image.from_blob(event.image_source).first.scale(410, 410)
